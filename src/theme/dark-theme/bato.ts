...
export const BatoDarkColor = `
    ...
    --color-theme-on-surface: hsl(180, 100.00%, 94.30%);
    --kendo-color-border-alt: hsl(24, 92%, 74%);

    --kendo-color-surface-alt: hsl(0, 0%, 9%);
    --kendo-color-surface: hsl(0, 0%, 9%);
    --kendo-color-subtle: hsl(228, 2%, 56%);
    --kendo-color-on-app-surface: hsl(0, 0%, 60%);

    --kendo-color-base-subtle: hsl(217, 7%, 21%);
    --kendo-color-base-subtle-hover: hsl(217, 7%, 40%);
    --kendo-color-base-subtle-active: hsl(0, 0%, 84%);
    --kendo-color-base: hsl(217, 7%, 21%);
    --kendo-color-on-base: hsl(0, 0%, 80%);
    --kendo-color-base-on-surface: hsl(0, 0%, 64%);
    --kendo-color-base-hover: hsl(0, 0%, 20%);
    --kendo-color-base-active: hsl(218, 14%, 20%);
    --kendo-color-base-emphasis: hsl(0, 0%, 76%);
    --kendo-color-base-on-subtle: hsl(0, 0%, 24%);
    ...
    --kendo-color-on-primary: hsl(206, 27%, 17%);
    ...
    --kendo-color-on-info: hsl(206, 27%, 17%);
    --kendo-color-info-on-surface: hsl(194, 65%, 42%);
`

export const BatoDarkPalette = getColorStore(BatoDarkColor, 'dark')
